...
jako dane ([`docs/taskspecs/POKER-12.json`](taskspecs/POKER-12.json))
— zrealizowany, czeka na audyt i integrację; następny w kolejce (b2):
arena porównawcza agentów, potem dane self-play (b3) i ML (b4) —
osobne kwalifikacje.
